...
GitHub code repository `r icon::fa("github")` [`siobhon-egan/BIO514-microbiome`](http://github.com/siobhon-egan/BIO514-microbiome)          
Website with information & tutorials `r icon::fa("link")` [`siobhonlegan.com/BIO514-microbiome`](http://siobhonlegan.com/BIO514-microbiome)
...
## Disclaimer `r icon::fa("exclamation-triangle", pull = "right")`

.small[
I don't consider myself to be a primarily a "coder". My scientific background and training has largely been in areas of biology, infectious disease (parasitology) and molecular biology/genomics. I become a bioinformatician out of need to analyse the data I generated in the lab.

My advice is to think of the world of coding as someone learning microsoft office for the first time. 

1. .purple[You don not have to be an expert]. Jump in and give it a go. Start with the basics and expand from there.
2. .purple[You'll pick up what you need to know as you go along]. Similar to above don't expect to be a professional at the start. Things will be messy but do whatever works for you!
3. .purple[There are lots of ways to do the same thing]. Just because what is on the person next to you screen doesn't mean what you have (or what they have is wrong).
4. .purple[Google is your friend]. First thing is just copy and paste error message into google. Forums like stack overflow will likely have your answer.
5. .purple[Document everything you do!] Find a way that works for you. I like `Rmarkdown` files, but to start with try just using a word/google doc to keep a record of your code.
]
...
I have also uploaded pre-processed QIIME2 sequence data as outlined in [sequence processing](04_sequence_processing.html). This is available for download on [FigShare](https://figshare.com/s/0c459524e59953bf2585). Download files and you can view them using [QIIME2 view](https://view.qiime2.org/).
...
## Methods `r icon::fa("flask",pull = "right")`
...
# Bioinformatics `r icon::fa("dna",pull = "right")`
...
## Sequence Processing `r icon::fa("dna",pull = "right")`
...
### Step 1. Demulitplex `r icon::fa("dna",pull = "right")`
...
### Step 2. Merge, Trim & Filter `r icon::fa("dna",pull = "right")`
...
### Step 3. Cluster or denoise `r icon::fa("dna",pull = "right")`
...
### Step 4. Assign taxonomy `r icon::fa("dna",pull = "right")`
...
---
## Links `r icon::fa("link",pull = "right")`
...
# Sequence Processing example `r icon::fa("dna",pull = "right")`
...
## My approach & recommendations: `r icon::fa("bookmark",pull = "right")`
...
## File formats `r icon::fa("folder",pull = "right")`
...
**FASTA** `r icon::fa("folder",pull = "right")`
...
**BIOM** `r icon::fa("folder",pull = "right")`
...
**Trees** `r icon::fa("folder",pull = "right")`
.small[
...
**R files** `r icon::fa("folder",pull = "right")`
...
## QIIME2 `r icon::fa("terminal",pull = "right")`
...
### Import data `r icon::fa("terminal",pull = "right")`
...
### Denoising `r icon::fa("terminal",pull = "right")`
...
### Phylogeny `r icon::fa("terminal",pull = "right")`
...
### Taxonomy `r icon::fa("terminal",pull = "right")`
...
## Data output `r icon::fa("table",pull = "right")`
...
otu_table <- read_csv("../data/otu_table.csv", skip = 1, col_names=FALSE)
...
# Data cleaning `r icon::fa("broom",pull = "right")`
...
## Check taxonomy `r icon::fa("broom",pull = "right")`
...
## Clean sequence count data `r icon::fa("broom",pull = "right")`
...
## Functional assignment `r icon::fa("broom",pull = "right")`
...
## Correct for 16S sequence abundance `r icon::fa("broom",pull = "right")`
...
# BREAK `r icon::fa("coffee",pull = "right")`

Make sure you have R installed for when we come back.

---

# Data Visualization `r icon::fa("chart-bar",pull = "right")`
...
## Download GitHub Repo `r icon::fa("chart-bar",pull = "right")`
...
## Load libraries `r icon::fa("chart-bar",pull = "right")`
...
## Load data `r icon::fa("chart-bar",pull = "right")`
...
## Inspect data `r icon::fa("chart-bar",pull = "right")`
...
---
`r icon::fa("chart-bar",pull = "right")`
...
## Rarefaction `r icon::fa("chart-bar",pull = "right")`
...
## Alpha diversity `r icon::fa("chart-bar",pull = "right")`
...
## Distribution plot `r icon::fa("chart-bar",pull = "right")`
...
## Taxa summary `r icon::fa("chart-bar",pull = "right")`
...
## Top taxa `r icon::fa("chart-bar",pull = "right")`
...
## Heatmap `r icon::fa("chart-bar",pull = "right")`
...
## Betadiversity `r icon::fa("chart-bar",pull = "right")`
...
### Ordination `r icon::fa("chart-bar",pull = "right")`
...
#### Detrended correspondence analysis (DCA) `r icon::fa("chart-bar",pull = "right")`
...
---
#### Canonical correspondence analysis (CCA) `r icon::fa("chart-bar",pull = "right")`
...
#### Redundancy analysis (RDA) `r icon::fa("chart-bar",pull = "right")`
...
#### Principal Coordinates Analysis (PCoA) `r icon::fa("chart-bar",pull = "right")`
...
#### Principal Coordinates Analysis (PCoA) with unifrac `r icon::fa("chart-bar",pull = "right")`
...
#### Non-metric Multidimensional Scaling (nMDS) `r icon::fa("chart-bar",pull = "right")`
...
### Statistical analysis `r icon::fa("chart-bar",pull = "right")`
...
## Hierarchical cluster analysis `r icon::fa("chart-bar",pull = "right")`
...
# EXPLORE `r icon::fa("dove",pull = "right")`
...
Here is one of my favourite links for all links microbiome and R.      
